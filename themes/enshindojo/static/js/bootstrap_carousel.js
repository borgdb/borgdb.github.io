 ...
 */
 ...
 (function ($) {
  ...
  function onPlayerStateChange(event) {
   ...
   function getCarouselSettingsFor(carousel) {
       // return Drupal.settings.bootstrap_carousel["node_" + carousel.data("nid")];
       return {};
   }

  function applyCarousel(){
      $('.carousel').each(function () {
          var carouselSettings = getCarouselSettingsFor($(this));
          $(this).carousel(carouselSettings).on('slide', function(event) {
